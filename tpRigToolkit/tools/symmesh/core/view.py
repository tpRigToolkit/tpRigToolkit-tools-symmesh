...
class SymmeshView(base.BaseWidget):
    ...
    def ui(self):
        ...
        select_geo_layout = layouts.GridLayout(spacing=2, margins=(2, 2, 2, 2))
        ...
        select_geo_layout.addWidget(self._select_geo_line, 0, 0)
        select_geo_layout.addWidget(self._select_base_geo_btn, 0, 1, Qt.AlignLeft)
        select_geo_layout.addWidget(self._symmetry_message, 1, 0, 1, 2)
